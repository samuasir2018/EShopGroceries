...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/style_interfaz_orders.css"></link>
               ...
               <div class="col-6 menuCentral">
                    <h2>Historial de pedidos</h2>
                        <?php
                            ...
                            $daoOrder->printOrderHistory($_SESSION['user']['email']);
                        ?>                                
               </div>
               <div class="col-1">
                    <!--Div Vacio-->
        ...
        <div class="row">
            <div class="col-4 leftColumnFooter">
                <b><p>E-Shop Groceries - Avenida de los institutos, s/n. 13600 Alcazar de San Juan (Ciudad Real) 
                    <br> Telf: 555-5555-555-55 -  e-mail: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX<br><br>
