           ...
           <div class="row">
               ...
               <div class="col-6 menuCentral">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <?php
                                echo "<input type='text' class='form-control inputTexto' name='DIRECCION' id='inputDireccion' placeholder='".$_SESSION['user']['address']."' disabled>";
                            ?>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-8">
                            <?php
                                echo "<input type='text' class='form-control inputTexto' name='CODIGOPOSTAL' id='inputCodigoPostal' placeholder='".$_SESSION['user']['postCode']."' disabled>";
                            ?>
                        </div>
                    </div>
               </div>
