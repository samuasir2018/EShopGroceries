...
<html lang="en">
    <head>
        ...
        <title>EShopGroceries - Buylist</title>
        ...
        <div class="container-fluid centroRegistro">
           <div class="row">
               <div class="col-10 tiraProductos">
                    <div class="row">
                    <?php
                        if (isset($_GET['BuylistId'])){
                            $buylistId = $_GET['BuylistId'];
                            if ($buylistId != null){
                                if ($buylistId == 1){
                                    echo '
                                    <h4>Semana de los lacteos: </h4><br>
                                    ';
                                } else if ($buylistId == 2){
                                    echo '
                                    <h4>Lo mejor de la panaderia: </h4><br>
                                    ';
                                } else if ($buylistId == 3){
                                    echo '
                                    <h4>Las mejores bebidas refrescantes: </h4><br>
                                    ';
                                }
                            }
                        } else{
                            echo ' <script type="text/javascript">location.href ="mercado.php"</script>';
                        }

                        $daoBuylist = new DaoBuylist();
                        $daoBuylist->printProductsBuylist($buylistId);
                    ?>
                    </div>
               </div>
